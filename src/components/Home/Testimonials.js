    ...
    <div id='testimonials' className='w-full px-5 sm:px-10 pt-16 2xl:pt-24 mb-16 md:mb-32 flex justify-center items-center'>
      <div className='w-full px-4 md:px-0 max-w-screen-2xl flex flex-col md:flex-row justify-start items-center'>
        <div className='relative w-full lg:w-[500px] 2xl:w-[500px] h-[320px] sm:h-[440px] lg:h-[540px] xl:h-[640px] mr-6 md:mr-0'>
          <img className='absolute z-20 w-full h-full object-cover rounded-[20px] rounded-br-[120px] top-6 2xl:top-10 left-6 2xl:left-10' src={dataHome[3].img} alt={dataHome[3].group} />
        ...
        <div className='flex flex-col justify-center items-start pl-0 md:pl-16 lg:pl-24 mt-16 lg:mt-0'>
          <h5 className='text-2xl text-secondary font-medium mb-6 md:mb-12'>{dataHome[3].group}</h5>
          <div className='flex items-center mb-2'>
            {Array.from({length: dataHome[3].stars}).map((item, starIndex) => (
          ...
          <p className='text-xl text-neutral-300 font-light mb-6 md:mb-12'>{dataHome[3].author}</p>
