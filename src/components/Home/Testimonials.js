...
const Testimonials = () => {
  return (
    <div id='testimonials' className='w-full px-5 sm:px-10 mt-16 2xl:mt-24 mb-16 flex justify-center items-center'>
      <div className='w-full lg:px-0 max-w-screen-2xl flex flex-col-reverse lg:flex-row justify-start items-center'>
        <div className='relative w-full lg:w-[500px] 2xl:w-[500px] h-[320px] sm:h-[400px] md:h-[560px] 2xl:h-[640px]'>
        ...
        <div className='flex flex-col justify-center items-start pl-24'>
          <h5 className='text-2xl text-secondary font-medium mb-8'>Happy Family</h5>
          <div className='flex items-center mb-2'>
            {Array.from({length: 5}).map((item, starIndex) => (
              <AiFillStar key={starIndex} className='text-yellow-400' size={32} />
            ))}
          </div>
          <h3 className='text-4xl leading-snug text-secondary mb-2'>
            What a great trip with my family and<br />I should try again next time soon ...
          </h3>
          <p className='text-xl text-neutral-300 font-light mb-12'>Angga, Product Designer</p>
