...
const Footer = () => {
  return (
    <div className='w-full px-5 sm:px-10 py-16 flex justify-center items-center border-t border-neutral-200'>
            ...
            <div key={index}>
              ...
              <div>
                {item[1].map((innerItem, innerIndex) => (
                  <h5 className='text-xl text-neutral-300 font-light py-1 cursor-pointer' key={innerIndex}>{innerItem}</h5>
                ))}
              </div>
            </div>
          ))}
